...
contract StreamingFeeWizardIntegrationGetStreamingFeeRecipientTest is Test {
    /*//////////////////////////////////////////////////////////////
                              VARIABLES
    //////////////////////////////////////////////////////////////*/
    ...
    /**
     * [REVERT] Should revert if asking for a chamber that does not exists
     */
    function testCannotGetStreamingFeeRecipientIfChamberDoesNotExist(
        address caller,
        address someChamber
    ) public {
        ...
        vm.prank(caller);
        streamingFeeWizard.getStreamingFeeRecipient(IChamber(someChamber));
    }
    ...
    /**
     * [SUCESS] Should return the expected recipient if the chamber exists
     */
    function testGetStreamingFeeRecipient(uint256 maxFeePercentage, uint256 feePercetange) public {
        ...
        address feeRecipient = streamingFeeWizard.getStreamingFeeRecipient(IChamber(chamberAddress));

        assertEq(address(this), feeRecipient);
    }
}
