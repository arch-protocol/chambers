...
contract StreamingFeeWizardIntegrationGetFeeStateTest is Test {
    /*//////////////////////////////////////////////////////////////
                              VARIABLES
    //////////////////////////////////////////////////////////////*/
    ...
    function testCannotLastCollectTimestampIfChamberDoesNotExist(
        ...
        vm.prank(caller);
        streamingFeeWizard.getFeeState(IChamber(someChamber));
    }
    ...
    /**
     * [SUCESS] Should return the fee state of a chamber
     */
    function testGetFeeState(uint256 maxFeePercentage, uint256 feePercetange) public {
        ...
        ) = streamingFeeWizard.getFeeState(IChamber(chamberAddress));

        assertEq(feeRecipient, address(this));
        assertEq(maxStreamingFeePercentage, maxFeePercentage);
        assertEq(streamingFeePercentage, feePercetange);
