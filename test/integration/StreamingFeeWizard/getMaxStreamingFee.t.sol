...
contract StreamingFeeWizardIntegrationGetMaxStreamingFeeTest is Test {
     ...
     */
    function testCannotGetMaxStreamingFeeIfChamberDoesNotExist(address caller, address someChamber)
        public
    {
        ...
        vm.prank(caller);
        streamingFeeWizard.getMaxStreamingFeePercentage(IChamber(someChamber));
    }
    ...
    /**
     * [SUCESS] Should return the expected max streaming fee if the chamber exists
     */
    function testGetMaxStreamingFee(uint256 maxFeePercentage, uint256 feePercetange) public {
        ...
        assertEq(maxFeePercentage, maxStreamingFeePercentage);
    }
}
