...
contract StreamingFeeWizardIntegrationGetStreamingFeePercentageTest is Test {
     ...
     */
    function testCannotGetStreamingFeePercentageIfChamberDoesNotExist(
        address caller,
        address someChamber
    ) public {
        ...
        vm.prank(caller);
        streamingFeeWizard.getStreamingFeePercentage(IChamber(someChamber));
    }
    ...
    /**
     * [SUCESS] Should return the streaming fee percentage if the chamber exists
     */
    function testGetStreamingFeePercentage(uint256 maxFeePercentage, uint256 feePercetange)
        public
    {
        ...
        assertEq(feePercetange, streamingFeePercentage);
    }
}
