...
contract ChamberUnitGetWizardsTest is Test {
    /*//////////////////////////////////////////////////////////////
                              LIBRARIES
    //////////////////////////////////////////////////////////////*/
    ...
    /**
     * [SUCCESS] The function getWizards() should return Wizards in Chamber
     */
    function testGetWizards() public {
        address[] memory chamberWizards = chamber.getWizards();
        assertEq(chamberWizards, wizards);
    }

    /**
     * [SUCCESS] The function getWizards() should return [] in Chamber with no Wizards
     */
    function testGetWizardsWithNoWizards() public {
        address[] memory noWizards = new address[](0);
        chamber = new Chamber(owner, name, symbol, constituents, quantities, noWizards, managers);
        address[] memory chamberWizards = chamber.getWizards();
        assertEq(chamberWizards, noWizards);
    }
}
