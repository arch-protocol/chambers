...
test-edge-cases-mainnet-fork :; FOUNDRY_FUZZ_RUNS=5 forge test --match-path "./test/edge-cases/**/*.sol" --fork-url https://eth-mainnet.g.alchemy.com/v2/$(ALCHEMY_ETH_API_KEY) --ffi -vvv
